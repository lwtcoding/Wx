...
font-size: 12px;
  ...
  <body>
    ...
    <s:form name="channelAddForm" action="channel_update" method="post">
   ...
   <s:hidden name="channel.id"/>	
	<s:textfield theme="simple" name="channel.name" />
	</td>
     </tr>
	...
	<td>是否自定义链接</td>
   <td colspan="">
	<s:select list="#{0:'否',1:'是'}" theme="simple" name="channel.customLink"></s:select>
	</td>
     </tr>
     ...
     <td>自定义链接地址</td>
   <td colspan="">
	<s:textfield theme="simple" name="channel.customLinkURL" />
	</td>
     </tr>
  ...
  <tr height="40" >
     <td>栏目类型</td>
   <td colspan="">
	<s:select list="types" listKey="key" listValue="value" headerValue="网站系统栏目" name="channel.channelType" theme="simple"></s:select>
...
<tr height="40" >
     <td>是否主页栏目</td>
   <td colspan="">
	<s:select list="#{0:'否',1:'是'}" theme="simple" name="channel.isIndex"></s:select>
	</td>
     </tr>
     ...
     <td>是否推荐栏目</td>
   <td colspan="">
	<s:select list="#{0:'否',1:'是'}" theme="simple" name="channel.recommend"></s:select>
	</td>
     </tr>
     ...
     <td>栏目状态</td>
   <td colspan="">
	<s:select list="#{0:'停用',1:'发布'}" theme="simple" name="channel.status"></s:select>
	</td>
     </tr>
...
<tr height="40" >
     <td>父类栏目</td>
   <td colspan="">
	<input type="hidden" name="pid" value="${pc.id}"/>
    ...
    <tr height="40" >
     <td>导航序号</td>
   <td colspan=""> 
   <s:textfield theme="simple" name="channel.navOrder" />
